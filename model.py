...
class Model(nn.Module):
    def __init__(self, dropout=False, with_CA=True, with_SA=True, drop_rate=0.3):
        ...
        # low level features
        self.conv14 = nn.Conv2d(64, 64, (3, 3), padding=1)  # conv1-2
        self.bn1 = nn.BatchNorm2d(num_features=64, affine=False)
        self.conv15 = nn.Conv2d(128, 128, (3, 3), padding=1)  # conv2-2
        self.bn2 = nn.BatchNorm2d(num_features=128, affine=False)

        self.conv16 = nn.Conv2d(192, 64, (3, 3), padding=1)  # conv on the sum of 1-2 and 2-2    ???
        ...
        # before the upsampling of high level features
